...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { limite_passageiro: @veiculo.limite_passageiro, nome: @veiculo.nome, valor: @veiculo.valor } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { limite_passageiro: @veiculo.limite_passageiro, nome: @veiculo.nome, valor: @veiculo.valor } }
